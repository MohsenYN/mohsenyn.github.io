...
<section class="apps-container">
  ...
  <div class="app-box beangpt" onclick="window.open('https://www.beangpt.ca','_blank')">
    <div class="icon" style="background-image: url('https://via.placeholder.com/120?text=GPT');"></div>
    <div class="info">
      <h2>BeanGPT</h2>
      <p>
  ...
  <div class="app-box allinone" onclick="window.open('https://allinone.shinyapps.io/AllInOne/','_blank')">
    <div class="icon" style="background-image: url('https://via.placeholder.com/120?text=AIO');"></div>
    <div class="info">
