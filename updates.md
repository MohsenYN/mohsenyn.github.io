...
<article class="news-item" aria-labelledby="news-2026-06-14">
  ...
  <p><strong>BeanGPT Presented at the International Legume Society Conference (ILS5)</strong><br>
    Artificial intelligence is creating new opportunities to transform how scientific knowledge is accessed, shared, and applied across agricultural research communities. As the volume of research continues to grow, there is an increasing need for tools that can help researchers efficiently navigate and utilize the vast amount of information available worldwide.
    <br><br>
    Recently, Dr. Mohsen Yoosefzadeh-Najafabadi presented BeanGPT at the 5th International Legume Society Conference (ILS5), an international event that brought together researchers, breeders, industry professionals, and students working across a wide range of legume crops. The presentation focused on how artificial intelligence can support scientific discovery by improving access to research knowledge and connecting information from diverse sources into a single platform.
    <br><br>
    The idea behind BeanGPT originated from a simple question: what if researchers could easily access not only their own data and publications but also the collective knowledge generated by scientists around the world? Every year, thousands of valuable research papers, datasets, reports, and discoveries are produced, yet much of this information remains scattered across different sources. BeanGPT was developed to help bridge these gaps and create a more connected and accessible knowledge ecosystem for the research community.
    <br><br>
    The presentation generated considerable interest and sparked discussions with researchers from multiple countries who shared similar perspectives on the future of scientific knowledge sharing. These conversations highlighted the growing need for tools that can help researchers quickly find relevant information, build upon existing discoveries, and reduce duplication of effort across research programs.
    <br><br>
    One of the most exciting aspects of BeanGPT is its broader vision. While the platform was initially developed within the dry bean research program at the University of Guelph, the underlying concept extends well beyond a single crop. Future developments will focus on expanding capabilities, incorporating additional knowledge sources, and supporting a wider range of agricultural and scientific disciplines.
    <br><br>
    By bringing together artificial intelligence and scientific knowledge, BeanGPT aims to make research information more accessible, encourage collaboration, and help researchers spend less time searching for information and more time generating new discoveries. As AI technologies continue to evolve, platforms such as BeanGPT may play an increasingly important role in strengthening global research networks and accelerating innovation across agriculture and plant science.
    <br><br>
    The lab is grateful for the continued support of students, collaborators, industry partners, and researchers who have contributed to the development of BeanGPT. It is exciting to see growing international interest in new approaches that connect knowledge, people, and ideas across the scientific community.
  </p>
</article>
...
<article class="news-item" aria-labelledby="news-2026-03-09">
  ...
  <figure>
    ...
    <img src="/assets/img/team/YifeiZhou.jpg" alt="Yifei Zhou" loading="lazy">
  </figure>
</article>
...
Please join me in welcoming Arwa, Taiya, and Chloe. We are very happy to have them, and I am very excited about what we will build together. More updates and news will be coming soon, so please stay tuned!
  ...
  <p><strong>Spotlight: Call for Papers: Transformative Computational Approaches for Plant Growth Prediction </strong><br>
   ...
   please visit <a href="https://www.frontiersin.org/research-topics/75569/transformative-computational-approaches-for-predicting-plant-growth-and-development" target="_blank" rel="noopener noreferrer"> Here </a>.
  </p>
</article>
