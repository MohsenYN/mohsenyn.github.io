...
<main class="join-us-container" role="main">
  ...
  <section class="opportunities" aria-labelledby="opportunities-heading">
    <h2 id="opportunities-heading">Opportunities to Collaborate</h2>
  ...
  <section class="previous-openings" aria-labelledby="previous-openings-heading">
...
<style>
  /* Custom Properties */
  :root {
    --primary-color: #9b1d64;
    --accent-color: #d94f8e;
    --border-color: #f4c430;
    --text-color: #333;
    --bg-gradient: linear-gradient(135deg, #4a2c5f 0%, #8e4b7e 100%);
